...
public class Paradigm {
    ...
    private final String romanianExplanation;
    private int iPartOfSpeech = 0; // as integer, from 1 to 9, 0 means
    // indeterminable.
    private String sPartOfSpeech = null; // default is indeterminable.
    private final String[] aPartsOfSpeech; // an array which extract from resources
    // the parts of speech as strings.
    private final String[] aPartsOfSpeechArticled; // an array which extract from
